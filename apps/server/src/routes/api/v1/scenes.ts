      ...
      try {
        ...
        const newScenes = await fastify.db
          ...
          .values({
            ...
            gridWidth: sceneData.gridWidth ?? 100,
            gridHeight: sceneData.gridHeight ?? 100,
            gridColor: sceneData.gridColor ?? '#000000',
            gridAlpha: sceneData.gridAlpha ?? 0.2,
            gridVisible: sceneData.gridVisible ?? true,
            gridLineWidth: sceneData.gridLineWidth ?? 1,
        ...
        const formattedScene: Scene = {
          ...
          gridWidth: newScene.gridWidth,
          gridHeight: newScene.gridHeight,
          gridOffsetX: newScene.gridOffsetX,
          gridOffsetY: newScene.gridOffsetY,
          gridColor: newScene.gridColor,
          gridAlpha: newScene.gridAlpha,
          gridVisible: newScene.gridVisible,
          gridLineWidth: newScene.gridLineWidth,
    ...
    async (request, reply) => {
      ...
      try {
        ...
        const formattedScene: Scene = {
          ...
          gridWidth: updatedScene.gridWidth,
          gridHeight: updatedScene.gridHeight,
          gridOffsetX: updatedScene.gridOffsetX,
          gridOffsetY: updatedScene.gridOffsetY,
